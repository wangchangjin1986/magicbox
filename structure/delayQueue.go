...
type BlockingDelayQueue struct {
	C chan interface{}
...
func NewBlockingDelayQueue(size int) *BlockingDelayQueue {
	return &BlockingDelayQueue{
...
func (dq *BlockingDelayQueue) Offer(elem interface{}, expiration int64) {
...
func (dq *BlockingDelayQueue) Poll(exitC chan struct{}, nowF func() int64) {
	for {
		now := nowF()
